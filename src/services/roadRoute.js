// Calcula una ruta real por calles entre varias paradas usando OSRM (un servicio público y…
...
function saveCache(cache) {
  try { sessionStorage.setItem(CACHE_KEY, JSON.stringify(cache)); } catch {/* sessionStorage lleno/bloqueado */}
}
